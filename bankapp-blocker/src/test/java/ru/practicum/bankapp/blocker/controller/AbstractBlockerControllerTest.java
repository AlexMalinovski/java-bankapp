...
import ru.practicum.bankapp.blocker.config.BlockerSecurityTestConfig;
...
@Import(value = BlockerSecurityTestConfig.class)
@ActiveProfiles("test")
@TestPropertySource(properties = {"spring.cloud.consul.port=8500", "spring.cloud.consul.host=localhost"})
public abstract class AbstractBlockerControllerTest {
